...
class ConversationsFilterBody(object):
    ...
    def __init__(self, payload=None):  # noqa: E501
        """ConversationsFilterBody - a model defined in Swagger"""  # noqa: E501
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this ConversationsFilterBody.  # noqa: E501
    ...
    def payload(self, payload):
        """Sets the payload of this ConversationsFilterBody.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConversationsFilterBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConversationsFilterBody):
            return False
